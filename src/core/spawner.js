...
const SPAWN_TYPES = [
  EnemyType.WOLF, EnemyType.GOBLIN, EnemyType.SPIDER, EnemyType.TROLL, EnemyType.WIGHT,
  EnemyType.ORC, EnemyType.GIANT_SPIDER, EnemyType.SHADOW, EnemyType.BARROW_WIGHT,
  EnemyType.GOBLIN_ARCHER, EnemyType.CORRUPTED_BEAR, EnemyType.DARK_CONSTRUCT, EnemyType.WRAITH,
];
