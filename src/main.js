...
import { getHeightAt, getBiomeAt } from './core/terrain.js';
import { applyGravity, resolveCollision } from './core/physics.js';
import { WorldRenderer } from './render/worldRenderer.js';
import { InputHandler } from './input.js';
import { raycast, placeBlock } from './core/actions.js';
import { getEnemyDrops } from './core/enemy.js';
import { BiomeType } from './core/biome.js';
import { Phase } from './core/gameClock.js';
import { createGameConfig } from './core/gameConfig.js';
import { createGameState } from './gameInit.js';
...
import { ITEM_TO_BLOCK, BlockType } from './core/block.js';
...
import { getCorruptionFogColor } from './core/corruptionVisuals.js';
import { toggleDoor, isDoorBlock } from './core/door.js';
import { worldBuildings, worldStations } from './core/worldData.js';
...
function startGame(config, jumpStateId) {
  ...
  // --- Single composition root for all game systems ---
  const gs = createGameState(config, { useWorker: true, onProgress: onLoadProgress });
  const {
    world, chunkMgr, player, inventory, survivalStats, race, cls, fullClassId,
    ...
    craftingSystem, craftingUI, statusEffects, questSystem, compass,
    factionSystem, npcSystem, mapScreen, stealthSystem, relicSystem,
    shelterSystem, loreJournal, fastTravel, discoverySystem, restSystem,
    freshnessTracker, blockBreaker, deathSystem, creativeMode, dialogueManager,
    spawnPos, classPassive, racialStyle, spawner, questTriggers, progress,
    chestStorage, droppedItems,
  } = gs;
  let { enemies, spawnTimer, dialogueMessage, dialogueTimer, invSelectedSlot,
    survivedFirstNight, isDead } = gs;
